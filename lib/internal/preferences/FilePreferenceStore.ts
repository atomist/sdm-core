 ...
 * @constructor
 */
export const FileBasedPreferenceStoreFactory: PreferenceStoreFactory = ctx => new FilePreferenceStore(ctx);
...
export class FilePreferenceStore extends AbstractPreferenceStore {
    ...
    constructor(private readonly context: HandlerContext,
                private readonly fileName: string = "client.preferences.json") {
        super(context);
    }

    public path(): string {
        const p = path.join(os.userInfo().homedir, ".atomist");
