 ...
 *
 * A job can execute any registered command handler in the same or other
 * connected SDM:
 *
 * command: name of the CommandHandlerRegistration or the registration instance itself
