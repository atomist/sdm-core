...
export type PushTestMaker = (params: any) => (pli: StatefulPushListenerInvocation) => Promise<boolean>;
export type GoalMaker = (sdm: SoftwareDeliveryMachine) => Goal | Promise<Goal>;
export type CommandMaker = (sdm: SoftwareDeliveryMachine) => Omit<CommandHandlerRegistration, "name"> | Promise<Omit<CommandHandlerRegistration, "name">>;
export type EventMaker = (sdm: SoftwareDeliveryMachine) => Omit<EventHandlerRegistration, "name"> | Promise<Omit<EventHandlerRegistration, "name">>;
export type ConfigurationMaker = (cfg: Configuration) => Configuration | Promise<Configuration>;
